...
if (!weight || !height) {
    ...
    if (bmi < 18.5) {
        ...
        bmiValueBottom.textContent = "Selamat! Anda memiliki berat badan yang ideal! Tetap pertahankan gaya hidup sehat ini, karena kesehatan adalah investasi terbaik untuk masa depan. Terus konsisten, nikmati prosesnya, dan tetap percaya diri!";
        bmiAdvice.textContent = "Selamat! Anda memiliki berat badan ideal!";
